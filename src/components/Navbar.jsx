    ...
    return (
        <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
            ...
            <div className='flex items-center'>
                ...
                <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2'>Herbivore <span className='font-bold'>Harvest</span> </h1>
            ...
            <div className={`fixed top-0 ${nav ? 'left-0' : 'left-[-100%]'} w-[300px] h-screen bg-white z-10 duration-300`}>
                ...
                <h2 className='text-2xl p-4'>Herbivore <span className='font-bold'>Harvest</span></h2>
                <nav>
